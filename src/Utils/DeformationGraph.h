...
class DeformationGraph
{
    public:
        ...
        void addConstraint(int vertexId, Eigen::Vector3f & target/*, u_char srcLabel, u_char targetLabel*/);
        void addRelativeConstraint(int vertexId, int targetId/*, u_char srcLabel, u_char targetLabel*/);
