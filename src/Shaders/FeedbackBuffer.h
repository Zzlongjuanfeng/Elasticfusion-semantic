...
class FeedbackBuffer
{
    public:
        ...
        void compute(pangolin::GlTexture * color,
                     ...
                     pangolin::GlTexture * label,
                     const int & time,
                     const float depthCutoff);

        void render(const bool flag_slam, pangolin::OpenGlMatrix mvp, const Eigen::Matrix4f & pose, const bool drawNormals, const bool drawColors);
