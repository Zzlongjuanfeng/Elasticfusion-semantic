...
class LiveLogReader : public LogReader
{
	public:
        ...
        void getNext(cv::Mat &image_in, cv::Mat &depth_in/*, Eigen::Matrix4f tran*/, const bool flag_slam, int count_global);
        ...
        void getBack(cv::Mat &image_in, cv::Mat &depth_in/*, Eigen::Matrix4f tran*/, const bool flag_slam,int count_global)
        {
