...
class GPUConfig
{
    ...
    private:
	    ...
	    icpStepMap["GeForce GTX 480"] = std::pair<int, int>(128, 96);
            rgbStepMap["GeForce GTX 480"] = std::pair<int, int>(128, 64);
            rgbResMap["GeForce GTX 480"] = std::pair<int, int>(160, 240);
            so3StepMap["GeForce GTX 480"] = std::pair<int, int>(128, 48);
